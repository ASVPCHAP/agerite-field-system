-- Supabase's DB rejects unqualified DELETE ("DELETE requires a WHERE
-- clause") — the previous migration's bare `delete from
-- certification_attempts;` failed this guard. Add a trivial WHERE true.
