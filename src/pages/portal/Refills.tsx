    ...
    <div>
      ...
      <div className="mt-2">
        <Note>
          ...
          cold. Runs off manually-tracked start dates for now; syncing this automatically from
          AGErite's SiCompounding order system is scoped for later, not built yet.
        </Note>
      </div>
